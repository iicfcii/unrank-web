    ...
    <Box>
      <Box justify='start' align='start' background='white' gap='medium' pad='xlarge'>
        ...
        <Paragraph margin='none' fill>
          ...
          We fed. We blamed the game. We lost the fun.
        </Paragraph>
        <Paragraph margin='none' fill>
        ...
        <Paragraph margin='none' fill>
          If you have any question, suggestion, or request,
          please email <a href='mailto:iicfcii@gmail.com'>us</a> at iicfcii@gmail.com.
        </Paragraph>
      </Box>
    </Box>
  );
